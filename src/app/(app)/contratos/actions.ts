...
const dadosSchema = z.object({
  ...
  multaContratadaDiaPercent: z.coerce.number().min(0).max(100),
  multaContratadaTetoPercent: z.coerce.number().min(0).max(100),
  paralisacaoDiaria: z.coerce.number().int().min(0),
...
export async function salvarDadosContrato(
  ...
  const parsed = dadosSchema.safeParse({
    ...
    multaContratadaDiaPercent: formData.get("multaContratadaDiaPercent"),
    multaContratadaTetoPercent: formData.get("multaContratadaTetoPercent"),
    paralisacaoDiaria: formData.get("paralisacaoDiaria"),
  ...
  await db
    ...
    .set({
      ...
      multaContratadaDiaPercent: d.multaContratadaDiaPercent,
      multaContratadaTetoPercent: d.multaContratadaTetoPercent,
      paralisacaoDiaria: d.paralisacaoDiaria,
